...
from api.table.base.knowledge_base import KnowledgeBase
from api.service.embedding_service import EmbeddingService, MetadataUpdateRequest, UnbindKbId
...
class KnowledgeBaseService:
    ...
    async def create_kb(self, data: Dict[str, Any]) -> int:
        ...
        sql_provider = None
        try:
            sql_provider = SqlProvider(model=KnowledgeBase, sql_config_path=self.sql_config_path)
    ...
    async def delete_kb(self, kb_id: int) -> bool:
        ...
        try:
            ...
            try:
                ...
                await self.embedding_service.unbind_kb_id(unbind_request)
            except Exception as e:
