...
class LLMConfigService:
    ...
    async def get_embedding_config_override(self, doc_id: int) -> EmbeddingConfigOverride:
        try:
            ...
            llm_config = await self.get_config_by_doc_id(doc_id, field_llm_name="embedding_llm_config")
            llm_config = await self.get_active_config(model_type=ModelType.EMBEDDING.value) if not llm_config else llm_config
